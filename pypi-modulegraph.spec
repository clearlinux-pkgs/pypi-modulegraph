...
Version  : 0.19.3
Release  : 8
URL      : https://files.pythonhosted.org/packages/c1/52/aad6eb110a2a33860fced95ccee0a733657b3065864bc8ff215e116854f8/modulegraph-0.19.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/c1/52/aad6eb110a2a33860fced95ccee0a733657b3065864bc8ff215e116854f8/modulegraph-0.19.3.tar.gz
...
%prep
%setup -q -n modulegraph-0.19.3
cd %{_builddir}/modulegraph-0.19.3
pushd ..
cp -a modulegraph-0.19.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664206207
...
cp %{_builddir}/modulegraph-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-modulegraph/2a5f8746735c45cf862a2c4037afc53d6a4ec81d || :
cp %{_builddir}/modulegraph-%{version}/doc/license.rst %{buildroot}/usr/share/package-licenses/pypi-modulegraph/f7c8530285650877d9b3d44075329c6dbf5de742 || :
